...
class BibleScreenState extends State<BibleScreen> {
  String currentTranslation = "개역개정";
  ...
  int _repeatMode = 2; // 0:정지, 1:한장반복, 2:계속반복
  Duration _duration = Duration.zero, _position = Duration.zero;

  final List<String> translations = ["개역개정", "개역한글", "새번역", "쉬운성경", "흠정역", "niv2011", "kjv1611", "nas2020", "히브리어", "프랑스어", "독일어", "일본어", "중국어", "러시아어", "베트남어", "네팔어", "터키어", "berean-interlinear"];
  ...
  Future<void> _loadVerses() async {
    ...
    setState(() { mainVerses = mainData; compareMap = cMap; });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(icon: const Icon(Icons.list), onPressed: () async {
          final result = await Navigator.push(context, MaterialPageRoute(builder: (context) => const BibleSelectionScreen()));
          if (result != null) {
            setState(() { currentBook = result['book']; currentChapter = result['chapter']; _loadVerses(); _startPlay(); });
          }
        }),
        title: Column(
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              DropdownButton<String>(
                ...
                onChanged: (v) { setState(() { currentTranslation = v!; _loadVerses(); }); },
              ),
              if (!isInterlinear) ...[
        ...
        actions: [
          IconButton(icon: const Icon(Icons.search), onPressed: () async {
            ...
            if (result != null) {
              setState(() {
                currentBook = result['book']; currentChapter = result['chapter']; _loadVerses();
                _audioPlayer.stop(); _isPlaying = false;
              });
            }
          }),
        ],
              ...
              return Padding(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text.rich(TextSpan(children: [
                    ...
                    TextSpan(text: v['Scripture'], style: const TextStyle(fontSize: 24, height: 1.4, fontFamily: 'serif')),
                  ])),
            ...
            child: Container(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Padding(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [1.0, 1.25, 1.5, 1.75, 2.0].map((s) =>
                      GestureDetector(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(onTap: () => _isPlaying ? _audioPlayer.pause().then((_) => setState(() => _isPlaying = false)) : _startPlay(),
